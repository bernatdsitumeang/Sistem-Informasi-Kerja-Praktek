<head>
	...
	<style>
		...
		#beranda .card{
			box-shadow:2px 2px rgba(0, 11, 255, 0.5);
			background-color: white;
			width: 250px;
		}
		#beranda .card:hover{
			box-shadow:2px 2px rgba(0, 11, 255, 0.75);
		}
...
<div class="container-fluid">
	<div class="row">
		<div class="col-xl-2 menu">
			...
			<a class="nav-link active" id="v-pills-beranda-tab" data-toggle="pill" href="#v-pills-beranda" role="tab" aria-controls="v-pills-beranda" aria-selected="true"><i class="fas fa-university"></i> Beranda</a>
				<a class="nav-link" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-university"></i> Kelola Data</a> 
		...
		<div class="col-md">
			...
			<div class="tab-content" id="v-pills-tabContent">
				...
				<div class="tab-pane fade show active" id="v-pills-beranda" role="tabpanel" aria-labelledby="v-pills-beranda-tab">
					<div class="row">
						<div class="col-md-auto col-auto">
							<a class="btn-menu" href="#"><i class="fas fa-bars"></i></a>	
						</div>
						<div class="col col-md">
							<h5 class="text-right nav-link"> Beranda </h5>
						</div>
					</div>
					<hr>
					<div id="beranda">
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="card-body">
								...
								<div style="display:flex; justify-content:space-between;">
									<p>12</p>
								<p class="card-text"><i class="fas fa-address-book"></i></p>
								</div>
						...
						<div class="col-sm-3">
							<div class="card text-dark" >
							<div class="card-body">
								<h5 class="card-title">Data Konsentrasi</h5>
								<div style="display:flex; justify-content:space-between;">
									<p style="width:120px;"><?php echo $konsen?></p>
								<p class="card-text"><i class="fas fa-address-book"></i></p>
								</div>
						...
						<div class="col-sm-3">
							...
							<div class="card-body">
								...
								<div style="display:flex; justify-content:space-between;">
									<p style="width:120px;"><?php echo $jurusan?></p>
								<p class="card-text"><i class="fas fa-address-book"></i></p>
								</div>
