		...
		$(document).ready(function() {
			$(".ideSkripsi").on('submit',
				function(e) {
					...
					swal({
							title: "Ide Kerja Praktek",
							text: "Terima Judul KP Ini",
							type: "warning",
	...
	<?php if (!$ideskripsi) { ?>
		<div class="row align-items-center m-5">
			<div class="col-md mb-5">
				<h2> Tidak Ada Mahasiswa yang Mengajukan Kerja Praktek </h2>
				Maaf saat ini tidak ada yang mengajukan ide Kerja Praktek.
			</div>
			<div class="col-md-3">
