...
<div class="row align-items-center">
	<div class="col-md mb-5">
		...
		Mahasiswa Saat Ini Belum Ada !! Anda Belum Bisa Mengirim Notifikasi Agenda Kegiatan Kerja Praktek
	</div>
	<div class="col-md-3">
...
<form method="POST" id="save_kegiatan" action="<?php echo base_url('Kaprodi/aksiKegiatan'); ?>">
		...
		<div class="row">
			...
			<div class="col-md">
				<div class="form-check">
					<input class="form-check-input" type="radio" name="kegiatan" id="gridRadios1" value="Seminar Kerja Praktek" checked>
		...
		<div class="clonedInput form-inline mb-3" id='clonedInput1'>
			<div class="form-group mr-1">
				<select class="custom-select clone" name="penerima[]">
					...
					<?php foreach ($userss->result() as $m) {?>
	...
	<div id='nama' class="form-row">
		<div class="clonedInput form-inline mb-3" id='clonedInput2'>
			<div class="form-group mr-1">
				<select class="custom-select" name="penerima[]">
					<option selected>Pilih</option>
					<option>Andang Wijanarko</option>
					<option>Ferzha Utama</option>
					<option>Aan Erlansari</option>
					<option>Arie Vatresia</option>
				</select>
			</div>
		</div>
	</div> -->
