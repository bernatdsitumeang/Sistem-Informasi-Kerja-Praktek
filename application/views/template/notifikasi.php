	...
	<div class="card">
		<div class='row align-items-center m-4'>
			<div class='col-md'>
				...
				KP dan mahasiswa yang bapak bimbing untuk melihat mahasiswa siapa yang bapak bimbing. bapak bisa melihat di
				navigasi KP.
				<?php } elseif ($_SESSION['Status'] === 'KP') { ?>
				<h2>Selamat Datang,
					<?= $_SESSION['Nama']?>. Sang Pejuang KP.</h2>
				Selamat ya karena menempuh semester 6 di Prodi Sistem Informasi dimana setiap mahasiswa S1 pasti akan mengalami yang namanya Fase
				pengerjaan KP. Saat ini Pemberitahuanmu Kosong. di Navigasi Ide Kerja Praktek Kamu Bisa mengajukan ide KP yang
				mungkin kamu punya. jadi bersiap siaplah jika sering di <b>TOLAK</b>. Semangat untuk Kamu !!!
				...
				memvalidasimu jika kau sudah mulai melakukan KP ! tetep semangat ya menjalani kehidupanmu di kampus !!!
				jika kamu sudah memasuki semester akhir dan masih belum bisa mengakses ide KP. silahkan tanyakan ke fakultas
				yah.
				<?php } ?>
			</div>
			<div class='col-md-3'>
