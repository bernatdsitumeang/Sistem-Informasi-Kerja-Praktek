...
class Kaprodi extends CI_Controller
{
    ...
    {
        // Dosen Penguji
        $dataa = array('ID' => $_SESSION['ID']);
        $userss = $this->M_data->find('users', $dataa);
        ...
        $dataa['userss'] = $this->M_data->find('users', $where);
        ...
        $this->load->view('kaprodi/formKegiatan', $dataa , $data);
    }
    ...
    public function acceptSkripsi($idSkripsi, $sta)
    {
        ...
        if ($sta === 'true') {
            ...
            for ($i = 1; $i < 2; $i++) {
                ...
                $Catatan = 'Anda Di Tetapkan Sebagai Dosen Pembimbing ' . $nama . ' Anda sekarang bisa mengacc proposal Kerja Praktek ' . $nama . ' dan juga menambah kartu bimbingan untuk mahasiswa tersebut Anda ditetapkan sebagai pembimbing ke ' . $i;
